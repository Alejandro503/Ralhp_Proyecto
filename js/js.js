...
function validacion(){
	...
	else if( mensaje == null || mensaje == 0 || !(validar_letrasyespacios(mensaje)) ) {
		alert('[ERROR] Ingrese su comentario correctamente \n Solo se admiten letras y espacios ');
		limpiar();
		return false;
	}
...
function validar_solonumerosdecimales (campo){
	var expresion = new RegExp("^[0-9]([0-9]|,)*\.?[0-9]*$","g");
		return expresion.test(campo);
}
...
cell5.innerHTML = this.paisalum;
cell4.innerHTML = this.mensajealum;
